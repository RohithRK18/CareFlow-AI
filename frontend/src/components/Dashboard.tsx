...
export const Dashboard: React.FC<DashboardProps> = ({ onStartSampleDischarge, onNavigate }) => {
  return (
    <div className="space-y-6">
      {/* Top Banner */}
      <div className="bg-gradient-to-r from-[#0B132B] via-[#0E1733] to-[#0B132B] border border-slate-800 rounded-2xl p-6 relative overflow-hidden shadow-xl">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 relative z-10">
          <div>
            <div className="flex items-center gap-2 mb-1.5">
              <span className="px-2.5 py-0.5 rounded text-[10px] font-extrabold tracking-wider bg-cyan-500/20 text-cyan-300 border border-cyan-500/30">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <button
              ...
              className="flex items-center gap-2 bg-gradient-to-r from-cyan-600 to-cyan-500 hover:from-cyan-500 hover:to-cyan-400 text-slate-950 font-bold px-4 py-2.5 rounded-lg text-xs transition-all shadow-lg shadow-cyan-500/20"
            >
            ...
            <button
              ...
              className="px-4 py-2.5 bg-slate-800 hover:bg-slate-700 text-slate-200 rounded-lg text-xs font-semibold border border-slate-700"
            >
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
        {[
          ...
          <div key={idx} className="bg-[#091024] border border-slate-800 rounded-xl p-3.5 shadow-md">
      ...
      <div className="bg-[#091024] border border-slate-800 rounded-xl p-5 space-y-4 shadow-lg">
        <div className="flex items-center justify-between">
          ...
          <button onClick={() => onNavigate('live-ops')} className="text-xs text-cyan-400 hover:underline flex items-center gap-1">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs text-slate-300">
            ...
            <tbody className="divide-y divide-slate-800/60 font-medium">
              <tr className="hover:bg-[#0E1733]/70 transition-colors">
                ...
                <td className="py-3.5 px-3">
                  <span className="inline-flex items-center gap-1 text-amber-300 font-bold px-2 py-0.5 bg-amber-500/20 rounded border border-amber-500/40 animate-pulse">
