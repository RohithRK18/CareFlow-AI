...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside className="w-64 bg-[#0B132B] border-r border-slate-800/80 flex flex-col h-screen select-none shrink-0 z-20">
      {/* Brand Header */}
      <div className="p-4 border-b border-slate-800/80 bg-[#070D1E] flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="h-9 w-9 rounded-lg bg-cyan-500/15 border border-cyan-500/40 flex items-center justify-center text-cyan-400 shadow-md shadow-cyan-500/10">
            <Activity className="h-5 w-5 animate-pulse" />
          </div>
          <div>
            <div className="flex items-center gap-1.5">
              <h1 className="font-extrabold text-slate-100 text-sm tracking-wide">CAREFlow AI</h1>
              <span className="text-[9px] font-bold px-1.5 py-0.2 rounded bg-purple-500/20 text-purple-300 border border-purple-500/30">v2.0</span>
            </div>
            <p className="text-[10px] text-cyan-400 font-medium tracking-wider uppercase">Care Orchestration</p>
          </div>
        </div>
      </div>
